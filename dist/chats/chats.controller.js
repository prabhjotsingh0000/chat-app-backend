...
let ChatsController = class ChatsController {
    ...
    async addChat(members) {
        const generatedId = await this.chatsService.insertChat(members);
    ...
    async updateChat(chatId, members) {
...
], ChatsController.prototype, "addChat", null);
__decorate([
    (0, common_1.Get)(),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], ChatsController.prototype, "getAllChats", null);
__decorate([
    (0, common_1.Get)(':id'),
...
__decorate([
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], ChatsController.prototype, "removeChat", null);
