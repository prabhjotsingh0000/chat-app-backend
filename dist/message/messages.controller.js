...
let MessagesController = class MessagesController {
    ...
    async addMessage(chat, sender, message) {
        const generatedId = await this.messagesService.insertMessage(chat, sender, message);
    ...
    async updateMessage(messageId, chat, sender, message) {
...
__decorate([
    (0, common_1.Patch)(':id'),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Body)('chat_id')),
    __param(2, (0, common_1.Body)('sender_id')),
...
__decorate([
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], MessagesController.prototype, "removeMessage", null);
